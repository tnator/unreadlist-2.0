...
const javascript = {
  ...
  use: [{
    ...
    // options: { presets: ['env'] }
    // I added this due to babel-preset-env move on npm site
    // options: {
    //   presets: [
...
//   use: MiniCssExtractPlugin.extract(['css-loader?sourceMap', postcss, 'sass-loader?sourceMap'])
// };
...
const config = {
  entry: {
    ...
    App: './public/javascripts/siteApp.js'
  },
  ...
  // I added this one after an npx webpack error
  mode: 'development',
