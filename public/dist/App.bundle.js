...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ajaxHeart);
...
function loadPlaces(map, lat = 29.1, lng = -82.1) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().get(`/api/sites/near?lat=${lat}&lng=${lng}`).then(res => {
    ...
    const infoWindow = new google.maps.InfoWindow(); // markers are the red dots on map
...
function makeMap(mapDiv) {
  if (!mapDiv) return; // make our map

  const map = new google.maps.Map(mapDiv, mapOptions);
  loadPlaces(map);
  const input = (0,_bling__WEBPACK_IMPORTED_MODULE_1__.$)('[name="geolocate"]');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (makeMap);
...
function typeAhead(search) {
  ...
  const searchResults = search.querySelector('.search__results'); // on is a shortcut in bling.js
  ...
  searchInput.on('input', function () {
    ...
    searchResults.style.display = 'block'; // will remove with backspace
    // searchResults.innerHTML = '';

    axios__WEBPACK_IMPORTED_MODULE_0___default().get(`/api/contactSearch?q=${this.value}`).then(res => {
      // console.log(res.data);
      if (res.data.length) {
        // Example if you type ORMC
        // console.log('There is something to show');
        const html = searchResultsHTML(res.data);
        searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize(searchResultsHTML(res.data));
        return;
      }

      ; // tell them nothing came back

      searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize(`<div class="search__result">No results for ${this.value} found!</div>`);
    }).catch(err => {
      console.error(err);
    });
...
/* harmony import */ var _modules_typeAhead__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/typeAhead */ "./public/javascripts/modules/typeAhead.js");
/* harmony import */ var _modules_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/map */ "./public/javascripts/modules/map.js");
/* harmony import */ var _modules_heart__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/heart */ "./public/javascripts/modules/heart.js");
// Need webpack to use this
...
(0,_modules_autocomplete__WEBPACK_IMPORTED_MODULE_1__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_0__.$)('#address'), (0,_modules_bling__WEBPACK_IMPORTED_MODULE_0__.$)('#lat'), (0,_modules_bling__WEBPACK_IMPORTED_MODULE_0__.$)('#lng'));
(0,_modules_typeAhead__WEBPACK_IMPORTED_MODULE_2__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_0__.$)('.search'));
(0,_modules_map__WEBPACK_IMPORTED_MODULE_3__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_0__.$)('#map'));
const heartForms = (0,_modules_bling__WEBPACK_IMPORTED_MODULE_0__.$$)('form.heart');
heartForms.on('submit', _modules_heart__WEBPACK_IMPORTED_MODULE_4__["default"]);
})();
